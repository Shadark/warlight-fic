...
\textsc{Problemas y Oportunidades} & \begin{enumerate}
...
\end{itemize}  \\ \hline
\textsc{Contexto Organizacional} & Indicar las características claves del contexto organizacional, así como colocar los
...
\begin{enumerate}
    ...
    \item Factores externos con los que tiene que tratar la organización
    \item Estrategia de la organización
    \item Escala de valores por la que se rige
\end{enumerate}    \\ \hline
\textsc{Soluciones} & Listar las posibles soluciones para los problemas y posibilidades percibidas

...
prácticas: xxx}{Modelado Contextual en CommonKADS.}
...
\begin{enumerate}
    ...
    \item Estrategia
	    \begin{itemize}
	    	\item \textbf{---AÑADIR O QUITAR ESTO---}
	    \end{itemize}
...
\begin{enumerate}
	...
	\item \emph{Implementación de un sistema de IA más avanzada para los jugadores más duchos.}
\end{enumerate} \\ \hline
\end{tabularx}
  \label{tab.OM1}
\end{table}
